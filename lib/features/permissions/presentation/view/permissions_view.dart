    ...
    return BlocConsumer<PermissionsBloc, PermissionsState>(
      listener: (context, state) {
        if (state.status == PermissionsStatus.success) {
          context.go('/permissions/next');
        }

        if (state.status == PermissionsStatus.error) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(state.message ?? 'Unable to continue'),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        PermissionItemCard(
                          ...
                          iconBackgroundColor: DSColors.info.withValues(
                            alpha: 0.10,
                          ),
                          title: 'Bluetooth',
                        ...
                        PermissionItemCard(
                          ...
                          iconBackgroundColor: DSColors.warning.withValues(
                            alpha: 0.10,
                          ),
                          title: 'Notifications',
                        ...
                        PermissionItemCard(
                          ...
                          iconBackgroundColor: DSColors.success.withValues(
                            alpha: 0.10,
                          ),
                          title: 'Microphone',
                          subtitle: 'For session reminders',
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(icon, color: iconColor, size: DSSpacing.xxl),
              ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: DSColors.error.withValues(alpha: 0.35)),
      ),
      child: const Icon(
...
class _DividerLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        const Expanded(child: Divider(color: DSColors.gray300)),
        Padding(
...
class _Badge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        label,
        style: DSTypography.caption.copyWith(color: DSColors.gray600),
      ),
    );
  }
}
...
class _BottomCta extends StatelessWidget {
  const _BottomCta({required this.isLoading});
